...
- Creative Suite (Beta): Character consistency profiles, LoRA training package export/import, Story/Comic generator plans, Movie storyboard planning, AI prompt assistant tools, AI preset recommender, pose changer plans, cloth changer plans, and facial expression changer plans
