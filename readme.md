...
- Creative Suite (Beta): Character consistency profiles, LoRA training package export/import, Story/Comic generator plans, Movie storyboard planning, AI prompt assistant tools, and an AI preset recommender
