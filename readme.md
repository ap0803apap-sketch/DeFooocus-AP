...
- Creative Suite (Beta): Character consistency profiles, LoRA training package export/import, Story/Comic generator plans, Movie storyboard planning, AI prompt assistant tools, AI preset recommender, pose changer plans, cloth changer plans, and facial expression changer plans, plus setup recipes for frogleo/AI-Clothes-Changer, HumanAIGC/OutfitAnyone, and fffiloni/expression-editor
...
| Colab | Info
| --- | --- |
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ap0803apap-sketch/DeFooocus-AP/blob/main/DeFooocus_colab.ipynb) | DeFooocus Official
